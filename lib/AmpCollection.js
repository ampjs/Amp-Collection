...
<<<<<<< HEAD:lib/AmpCollection.js
=======

        this.FingerPrint = new _FingerPrint2.default();
>>>>>>> feature/object-hash:lib/AmpCollection.js
    ...
    _createClass(AmpCollection, [{
        ...
        value: function doWhere(processed, key, operator, value) {
            ...
            for (var item = 0; item < this.data.length; item++) {
                ...
                var where = this.__whereOperators(this.data[item][key], operator, value);
        ...
        key: '__whereOperators',
        value: function __whereOperators(key, operator, value) {
            switch (operator) {
                default:
                case '=':
                case '==':
